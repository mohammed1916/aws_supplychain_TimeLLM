...
import { useForecasts, useInventoryAlerts, useKPIs } from './hooks/useApiData';
...
function App() {
  ...
  // Fallback to static data if API fails or during initial load
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {kpiLoading ? (
                  <div className="col-span-full flex justify-center py-8">
                    <LoadingSpinner text="Loading KPIs..." />
                  </div>
                ) : (
                  ...
                  {forecastLoading ? (
                    ...
                    <div className="relative h-80">
                      <div className="absolute inset-0 flex items-end justify-between px-4">
                        {displayForecastData.map((data, index) => (
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-slate-200">
                  ...
                  {alertsLoading ? (
                    ...
                    <div className="space-y-3">
                      {displayInventoryAlerts.slice(0, 3).map((alert, index) => (
